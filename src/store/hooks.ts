...
export const useStore = create<OrchardState>()(
    persist(
        immer((set) => {
            return {
                q: '',
                ...
                setFilter: <T extends FilterKey>(
                    cat: T,
                    func: VoidFunc<WritableDraft<FilterMap>[T]>
                ) =>
                    set((draft) => {
                ...
                setPreference: (pref: PreferenceKey, value: string) =>
                    set((draft) => {
...
export const useSetFilter = <T extends FilterKey>(name: T) => {
    ...
    const setFilter = (f: VoidFunc<WritableDraft<FilterMap>[T]>) =>
        _setFilter<T>(name, f);
    return setFilter;
};
