import { atom, ExtractAtomUpdate, ExtractAtomValue, useAtom } from "jotai";
import { immerAtom, persistAtom } from "./utils";
...
type Test2<T> = Parameters<typeof persistAtom<T>>
const persistedFilterAtom = <T>(...a: Test2<T>) => immerAtom<T>(persistAtom<T>(...a));
