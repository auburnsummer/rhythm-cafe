...
export function Preferences({ class: _class }: PreferencesProps) {
    ...
    const [levelsPerPage, setLevelsPerPage] = usePreference(
        'levels per page',
        As.NUMBER
    );
    const [advancedFilters, setAdvancedFilters] = usePreference(
        'show advanced filters',
        As.STRING
    );
    const [levelDetails, setLevelDetails] = usePreference(
        'show more level details',
        As.STRING
    );
    const [useCfCache, setUseCfCache] = usePreference(
        'use cf cache',
        As.STRING
    );
    const [rowView, setRowView] = usePreference('row view', As.STRING);
    const [liveSearch, setLiveSearch] = usePreference(
        'search as you type',
        As.STRING
    );
    const [exactSearch, setExactSearch] = usePreference(
        'exact search',
        As.STRING
    );
    ...
    return (
        <div class={cc(_class, 'pr')}>
            ...
            <div
                class={cc('pr_panel', { 'showing!pr_panel': expanded })}
                ref={panelRef}
            >
                <ul class="pr_list">
                    <li class="pr_row">
                        ...
                        <div class="pr_textline">
                            ...
                            <PreferenceSelect
                                value={rowView}
                                onChange={(e) =>
                                    setRowView(e.currentTarget.value)
                                }
                            >
                    ...
                    <li class="pr_row">
                        ...
                        <div class="pr_textline">
                            ...
                            <PreferenceSelect
                                value={levelsPerPage}
                                onChange={(e) =>
                                    setLevelsPerPage(e.currentTarget.value)
                                }
                            >
                    ...
                    <li class="pr_row">
                        ...
                        <div class="pr_textline">
                            ...
                            <PreferenceSelect
                                value={liveSearch}
                                onChange={(e) =>
                                    setLiveSearch(e.currentTarget.value)
                                }
                            >
                    ...
                    <li class="pr_row">
                        ...
                        <div class="pr_textline">
                            <PreferenceSelect
                                ...
                                onChange={(e) =>
                                    setAdvancedFilters(e.currentTarget.value)
                                }
                            >
                    ...
                    <li class="pr_row">
                        ...
                        <div class="pr_textline">
                            <PreferenceSelect
                                value={levelDetails}
                                onChange={(e) =>
                                    setLevelDetails(e.currentTarget.value)
                                }
                            >
                                <option value="false">Hide</option>
                                <option value="true">Show</option>
                        ...
                        <li class="pr_row">
                            ...
                            <div class="pr_textline">
                                <PreferenceSelect
                                    value={useCfCache}
                                    onChange={(e) =>
                                        setUseCfCache(e.currentTarget.value)
                                    }
                                >
